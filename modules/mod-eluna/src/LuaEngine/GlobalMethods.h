...
namespace LuaGlobalFunctions
{
    ...
    /**
     * like WorldDBExecute but blocking
     */
    int WorldDBExecuteSync(lua_State* L)
    {
        const char* query = Eluna::CHECKVAL<const char*>(L, 1);
    ...
    /**
     * like CharDBExecute but blocking
     */
    int CharDBExecuteSync(lua_State* L)
    {
        const char* query = Eluna::CHECKVAL<const char*>(L, 1);
    ...
    /**
     * like AuthDBExecute but blocking
     */
    int AuthDBExecuteSync(lua_State* L)
    {
        const char* query = Eluna::CHECKVAL<const char*>(L, 1);
        LoginDatabase.DirectExecute(query);
        return 0;
    }
